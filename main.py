...
from google_drive.gdrive import Gdrive
...
console.log("Google drive folder creation...")
gdrive = Gdrive(console)
console.log("Google drive folder done.")

for i in range(0, 3):
    console.log("Video " + str(i))
    pygame.init()
    ...
    video_path = video.make_full_video()
    gdrive.upload(video_path)